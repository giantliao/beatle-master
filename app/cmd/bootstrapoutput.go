...
var bootstrapOutputFile string
...
func init() {
	bootstrapCmd.AddCommand(outputCmd)
	...
	outputCmd.Flags().StringVarP(&bootstrapOutputFile, "filename", "f", "bootstrap.list", "output a bootstrap server list")
