...
func GetBTLCoinToken() *BTLCoinToken {
	...
	gBTLCoinTokenInst = &BTLCoinToken{
		ethAccessPoint: cfg.EthAccessPoint,
...
func (bcw *BTLCoinToken)CheckHashAndGet(hash common.Hash) (coin float64, fromAddr, toAddr common.Address,err error) {
